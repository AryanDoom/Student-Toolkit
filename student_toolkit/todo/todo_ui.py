...
def open_todo_list(root):
    ...
    ctk.CTkButton(todo_window,text="Add Task",command=add_task,text_color="white",corner_radius=18,height=36,width=130).pack(pady=5)
    ...
    ctk.CTkButton(todo_window,text="Delete Selected",command=delete_selected,text_color="#1e90ff",corner_radius=18,height=36,width=130).pack(pady=5)

    ctk.CTkButton(todo_window,text="Clear All",command=clear_tasks,text_color="#1e90ff",corner_radius=18,height=36,width=130).pack(pady=5)
