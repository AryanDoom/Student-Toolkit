...
def open_llm(root):
    ...
    response_box = ctk.CTkTextbox(chat_frame,width=820,height=450,wrap="word",font=("Agency FB", 15),fg_color="#000000",corner_radius=8,text_color="White")
    ...
    llm_entry = ctk.CTkEntry(input_frame,font=("Agency FB", 15),corner_radius=12,height=40)
