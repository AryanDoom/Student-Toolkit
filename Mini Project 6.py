...
def label(text):
    ...
    Label(window, text="Subject Name", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    sucbject_entry = tk.Entry(window, font=("Segoe UI", 12))
    subject_entry.pack()

    tk.Label(window, text="ISA 1 Score (out of 40)", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    isa1_entry = tk.Entry(window, font=("Segoe UI", 12))
    isa1_entry.pack()

    tk.Label(window, text="ISA 2 Score (out of 40)", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    isa2_entry = tk.Entry(window, font=("Segoe UI", 12))
    isa2_entry.pack()

    tk.Label(window, text="Assignment Score (out of 10)", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    assignment_entry = tk.Entry(window, font=("Segoe UI", 12))
    assignment_entry.pack()

    tk.Label(window, text="ESA Score (out of 100)", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    esa_entry = tk.Entry(window, font=("Segoe UI", 12))
    esa_entry.pack()

    tk.Label(window, text="Lab Score (only for Chemistry/Python/Physics)", font=("Segoe UI", 12), bg="#0a0a0a", fg="#1e90ff").pack(pady=5)
    lab_entry = tk.Entry(window, font=("Segoe UI", 12))
    lab_entry.pack()
